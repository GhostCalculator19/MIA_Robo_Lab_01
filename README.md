...
Также был генерован интерактивный отчёт в формате **HTML**, представлен в [YData Report](file://D:/HereAgain/CALOIRO%202025/Programming/LAB_MAI_01/Reports/ydata_report1.html/). отчёт включает в себя:

...
Также был генерован интерактивный отчёт в формате **HTML**, представлен в [YData Report](https://ghostcalculator19.github.io/Reports/ydata_report1.html/). отчёт включает в себя:
